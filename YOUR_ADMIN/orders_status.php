...
//-bof-sorted_orders_status-lat9  *** 1 of xx ***
          $sql_data_array = array('orders_status_name' => zen_db_prepare_input($orders_status_name_array[$language_id]),
                                  'sort_order' => zen_db_prepare_input($_POST['orders_status_sort_order']),
                                 );
//-eof-sorted_orders_status-lat9  *** 1 of xx ***
          if ($action == 'insert') {
          ...
          <tr>
            <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr class="dataTableHeadingRow">
                <td class="dataTableHeadingContent"><?php echo TABLE_HEADING_ORDERS_STATUS_ID; ?></td> <?php //-sorted_orders_status-lat9  *** 2 of xx *** ?>
                <td class="dataTableHeadingContent"><?php echo TABLE_HEADING_ORDERS_STATUS; ?></td>
                <td class="dataTableHeadingContent"><?php echo TABLE_HEADING_SORT_ORDER; ?></td> <?php //-sorted_orders_status-lat9  *** 3 of xx *** ?>
                <td class="dataTableHeadingContent" align="right"><?php echo TABLE_HEADING_ACTION; ?>&nbsp;</td>
              </tr>
<?php
  $orders_status_query_raw = "select orders_status_id, orders_status_name, sort_order from " . TABLE_ORDERS_STATUS . " where language_id = '" . (int)$_SESSION['languages_id'] . "' order by sort_order";  //-sorted_orders_status-lat9  *** 4 of xx ***
  ...
  while (!$orders_status->EOF) {
    ...
    echo '                    <td class="dataTableContent">' . $orders_status->fields['orders_status_id'] . '</td>'; //-sorted_orders_status-lat9  *** 5 of xx ***
    ...
    echo '                    <td class="dataTableContent">' . $orders_status->fields['sort_order'] . '</td>'; //-sorted_orders_status-lat9  *** 6 of xx ***
?>
...
//-bof-sorted_orders_status-lat9  *** 7 of xx ***
      $contents[] = array('text' => '<br>' . TEXT_INFO_SORT_ORDER . '<br />&nbsp;&nbsp;&nbsp;&nbsp;' . zen_draw_input_field('orders_status_sort_order', $oInfo->sort_order));
//-eof-sorted_orders_status-lat9  *** 7 of xx ***
...
//-bof-sorted_orders_status-lat9  *** 8 of xx ***
      $contents[] = array('text' => '<br>' . TEXT_INFO_SORT_ORDER . '<br />&nbsp;&nbsp;&nbsp;&nbsp;' . zen_draw_input_field('orders_status_sort_order', $oInfo->sort_order));
//-eof-sorted_orders_status-lat9  *** 8 of xx ***
